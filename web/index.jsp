                    ...
                    <div class="col-lg-12">
                        <div class="hc-inner-text">
                            <div class="hc-text">
                                ...
                                <h5>R$500.000,00<span>/Total</span></h5>
                            </div>
                            <div class="hc-widget">
                                <ul>
                    ...
                    <div class="col-lg-12">
                        <div class="hc-inner-text">
                            <div class="hc-text">
                                ...
                                <p><span class="icon_pin_alt"></span> Local do Imóvel</p>
                                <div class="label">Comprar</div>
                                <h5>R$200.000,00<span>/Total</span></h5>
                            </div>
                            <div class="hc-widget">
                                <ul>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="section-title">
                    <h4>Qual imóvel você procura?</h4>
                </div>
            </div>
            <div class="col-lg-5">
        ...
        <div class="search-form-content">
            <form action="#" class="filter-form">
                ...
                <select class="sm-width">
                    ...
                    <option value="mais">Mais de cinco</option>
                </select>
                <select class="sm-width">
                ...
                <div id= "priceCompra" class="price-range-wrap sm-width">
                    <div class="price-text">
                        <label for="priceRange">Valor:</label>
                        <input type="text" id="priceRangeCompra" readonly>
                    </div>
                    <div id="price-range-compra" class="slider"></div>
                </div>
