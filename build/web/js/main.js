...
(function ($) {
    ...
    $("#price-range-compra").slider({ 
        ...
        slide: function (event, ui) {
            $("#priceRangeCompra").val("[ " + ui.values[0] + " - " + ui.values[1] + " ]" + "R$");
        }
    });
    $("#priceRangeCompra").val("[ " + $("#price-range-compra").slider("values", 0) + " - " + $("#price-range-compra").slider("values", 1) + " ]" + "R$");
